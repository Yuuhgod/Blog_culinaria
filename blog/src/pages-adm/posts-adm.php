<div class="main-posts" id="posts">
            ...
            if ($totalRegistros > 0) {
                while ($exibe = $result->fetch(PDO::FETCH_OBJ)) {
                    ...
                    <div class="col-md-6"> <!-- Dividindo em 2 colunas para ter no máximo 2 cards por linha -->
                        <div class="card">
                            <a href="./recipe-adm.php?id=<?php echo $exibe->id; ?>">
                                <img src="../public/images/cards/<?php echo $exibe->imagem; ?>" class="card-img-top"
                                    alt="<?php echo $exibe->titulo; ?>" title="<?php echo $exibe->titulo; ?>">
                            </a>
                            <div class="card-body">
    ...
    <div>
        <a href="post/create.php"><button id="btn">
            <span class="material-icons align-middle">add</span> Adicionar
        </button></a>
    </div>
</div>