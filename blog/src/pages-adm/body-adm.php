...
<ul class="nav justify-content-center">
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="admin.php?category=1">Café da Manhã</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="admin.php?category=2">Almoço</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="admin.php?category=3">Sobremesas</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="admin.php?category=4">Jantar</a>
  </li>
</ul>